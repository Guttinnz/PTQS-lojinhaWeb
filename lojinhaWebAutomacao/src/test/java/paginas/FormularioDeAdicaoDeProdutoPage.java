...
public class FormularioDeAdicaoDeProdutoPage {
    ...
    public FormularioDeAdicaoDeProdutoPage informaValorProduto(String produtoValor){
        navegador.findElement(By.name("produtovalor")).sendKeys(produtoValor);
        return this;
    }

    public FormularioDeAdicaoDeProdutoPage informaCoresProduto(String produtoCores){
