...
public class FormularioAdicaoProdutoTela extends BaseTela{
   ...
   public FormularioAdicaoProdutoTela preencherValorPorduto(String valorProduto) {
   ...
   public FormularioAdicaoProdutoTela preencherCoresProduto(String corProduto) {
